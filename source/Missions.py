...
# ============================ Client / Server mode
	...
	def init(cls):
		...
		cls.missions.append(Mission("One on one", ["Rafale"], ["Rafale"], 1, 1, Missions.mission_setup_players, Missions.mission_one_against_x_end_test, Missions.mission_one_against_x_end_phase_update))
